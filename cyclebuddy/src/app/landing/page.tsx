  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-white">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 right-1/3 w-20 h-20 bg-pink-200 rounded-full opacity-30 blur-lg"></div>
      </div>
      ...
      <header className="relative z-10 px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="#rewards" className="text-gray-700 hover:text-pink-600 transition-colors">Rewards</a>
            ...
            <a href="#support" className="text-gray-700 hover:text-pink-600 transition-colors">Support</a>
          </nav>
...
{account.length > 20 ? `${account.slice(0, 10)}...${account.slice(-6)}` : `${account.slice(0, 6)}...${account.slice(-4)}`}
              </div>
              <button
            ...
            <button
              ...
              className="bg-pink-500 hover:bg-pink-600 disabled:bg-pink-300 text-white px-6 py-2 rounded-full font-medium transition-colors flex items-center space-x-2"
            >
              <span>🔗</span>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              {/* Floating Cards */}
              {/* Cycle Trends Card */}
              <div className="absolute -top-8 -right-8 bg-white rounded-xl p-3 shadow-lg border border-pink-100 w-32">
                <div className="text-xs font-semibold text-gray-800 mb-2">Cycle trends</div>
                <div className="h-8 bg-gradient-to-r from-pink-200 to-pink-400 rounded"></div>
              </div>

              {/* Symptom Patterns Card */}
              <div className="absolute top-20 -left-12 bg-white rounded-xl p-3 shadow-lg border border-pink-100 w-28">
                <div className="text-xs font-semibold text-gray-800 mb-2">Symptom patterns</div>
                <div className="flex space-x-1">
              ...
              {/* Chat Assistant */}
              <div className="absolute -bottom-8 left-8 bg-white rounded-2xl p-3 shadow-lg border border-pink-100">
                <div className="flex items-center space-x-2">
                  <div className="w-8 h-8 bg-pink-500 rounded-full flex items-center justify-center">
                    <span className="text-white text-sm">🤖</span>
                  </div>
                  <div>
                    <div className="text-sm font-medium text-gray-800">Hi 😊 I'm CycleBuddy</div>
                    <div className="text-xs text-gray-600">Rewards Assistant</div>
                  </div>
                </div>
              </div>
            </div>
